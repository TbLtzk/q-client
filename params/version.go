...
const (
	...
	QVersionMinor = 0    // QGOV-Client minor version component of the current release
	QVersionPatch = 0    // QGOV-Client patch version component of the current release
	QVersionMeta  = "rc" // QGOV-Client version metadata to append to the version string
)
