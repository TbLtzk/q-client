...
var (
	...
	TxPoolPriceLimitFlag = &cli.Uint64Flag{
		...
		Usage:    "Minimum gas price tip to enforce for acceptance into the pool. EPQFI param will be used by default",
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	CheckExclusive(ctx, MainnetFlag, DeveloperFlag, GoerliFlag, SepoliaFlag, HoleskyFlag, TestnetFlag, FischerFlag)
