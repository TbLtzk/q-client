...
- Sentry.io integration. If configured, q-client will send alerts about critical/fatal errors/set of blockchain-related
  error (bad blocks, etc.)
- Root list flexibility. Root nodes can propose root list without themselves, active root list is no longer compared
  with on-chain list.
...
- Constitution storage. The part of the L0 that allows you to store and request the required constitution files.
  See [more detailed description](governance/README.adoc)
- Updated initial root nodes for Mainnet
