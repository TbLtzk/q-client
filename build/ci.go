...
import (
	...
	signifyPkg "gitlab.com/q-dev/q-client/crypto/signify"
	"gitlab.com/q-dev/q-client/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "gitlab.com/q-dev/q-client/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "gitlab.com/q-dev/q-client/mobile")
