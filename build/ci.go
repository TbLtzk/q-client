...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "gitlab.com/q-dev/q-client/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "gitlab.com/q-dev/q-client/internal/version.gitDate="+env.Date)
	}
